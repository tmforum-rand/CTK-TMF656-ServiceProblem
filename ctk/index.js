...
var DefaultURL = "${APIDEFAULTURL}/tmf-api/serviceProblemManagement/v3/";
var schema;
var hostname;
var port;
...
function getURL(){
    ...
    'https://apictk-service-problem-management-v3-0-0.mybluemix.net/tmf-api/serviceProblemManagement/v3/serviceProblem\n'+
    'becomes\n'+
    'https://apictk-service-problem-management-v3-0-0.mybluemix.net/tmf-api/serviceProblemManagement/v3\n>', (answer) => {
    DefaultURL = answer;
    rl.close();
    isURLValid(answer);

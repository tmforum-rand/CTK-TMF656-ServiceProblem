...
var DefaultURL = "${APIDEFAULTURL}/tmf-api/serviceProblemManagement/v4/";
var schema;
var hostname;
var port;
var APIRelativeAddress;
var statusCode;
const exampleEndPoint = "/serviceProblem";
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout
});

console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF656 ServiceProblem R18 5\n");
getURL();
...
function getURL(){
    ...
    'https://apictk-service-problem-management-v4-0-0.mybluemix.net/tmf-api/serviceProblemManagement/v4/serviceProblem\n'+
    'becomes\n'+
    'https://apictk-service-problem-management-v4-0-0.mybluemix.net/tmf-api/serviceProblemManagement/v4\n>', (answer) => {
    DefaultURL = answer;
    rl.close();
    isURLValid(answer);
...
function exportEnvironment(url){
    ...
    envJson.values.forEach(element => {
        if (element.key == "ServiceProblemAPI"){
            element.value = url;
        }
    });
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF656-ServiceProblem-R18-5.postman_collection.json'),

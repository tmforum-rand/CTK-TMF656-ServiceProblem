...
Once Node.js and npm are installed download and unzip the CTK-TMF656-ServiceProblem-R18-5 ZIP file within your test directory.
...
>https://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceProblemManagement/v4/serviceProblem

You should input:
>https://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceProblemManagement/v4/
...
![CTK Example Image](https://github.com/tmforum-rand/CTK-TMF656-ServiceProblem-R18-5/blob/master/images/Output-Example.png)
